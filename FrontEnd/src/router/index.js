...
const routes = [
  ...
  // { path: '/detail/Invoice/Home', component: InvoiceIndex},
  ...
  {path: '/ProductCatalog/importProduct', component: NewInventoryProduct, meta: { requiresAuth: true }},
...
//   if (requiresAuth && (!employee || employee === 'null' || employee === 'undefined')) {
//     next('/SignIn');
//   } else {
//     next();
//   }
