  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="introduce" v-if="selectedSection === 'introduce'">
        <p style="font-size: 20px; font-weight: 600; padding-left: 50px">
          🔹 Giới thiệu chung về hệ thống ABYSS
        </p>
        <p>
          Ngày nay, việc quản lý siêu thị mini và cửa hàng bán lẻ đòi hỏi sự chính xác, linh hoạt và
          hiệu quả cao. ABYSS ra đời như một giải pháp tối ưu giúp các chủ cửa hàng quản lý hoạt
          động kinh doanh một cách dễ dàng và khoa học.
        </p>
        <p>
          Hệ thống ABYSS không chỉ hỗ trợ kiểm soát hàng tồn kho, quản lý đơn hàng mà còn cung cấp
          các tính năng phân tích doanh thu, tối ưu quy trình bán hàng và tích hợp phương thức thanh
          toán hiện đại. Với giao diện trực quan, dễ sử dụng, ABYSS phù hợp với mọi đối tượng người
          dùng, từ những người mới bắt đầu kinh doanh đến các chủ cửa hàng lâu năm.
        </p>
      </div>
      <div class="feature" v-if="selectedSection === 'feature'">
        <p style="font-size: 25px; font-weight: 600; padding-left: 50px">
          🔹 Tính năng nổi bật của ABYSS:
        </p>
