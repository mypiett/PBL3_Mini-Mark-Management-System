...
<template>
  <div class="nav-menu">
    ...
    <div class="menu">
      <a href="#" @click.prevent="goToHome"> <i class="fa fa-home"></i> Trang chủ </a>
      ...
      <div class="product" @click.prevent="clickMenu('product')">
        ...
        <div class="hidden-product" v-show="isOpened === 'product'">
          <router-link to="/productCatalog"> Danh sách sản phẩm </router-link>
          <router-link to="/priceProductList"> Bảng giá </router-link>
        </div>
      </div>
      ...
      <div class="warehouse_management" @click.prevent="clickMenu('warehouse_management')">
        ...
        <div class="hidden-warehouse_management" v-show="isOpened === 'warehouse_management'">
          <router-link to="/inventoryProduct"> Tồn kho </router-link>
          <router-link to="/importGoodList"> Danh sách nhập </router-link>
          <router-link to="/importProduct"> Nhập hàng </router-link>
